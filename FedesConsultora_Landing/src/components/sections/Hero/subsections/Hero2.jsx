        ...
        <div className='hero-2-subsection'>
            <div className="hero-2-container">
                <div className="hero-2-content">
                    <h2>Contanos qué te está pasando
                    </h2>
                    ...
                    <div className="cure-options">
                        <div
                            className="cure-pill"
                            onClick={() => window.dispatchEvent(new CustomEvent('open-fedi', { detail: { message: 'Vendemos mucho, pero a fin de mes no queda plata en la caja' } }))}
                        >
                            Vendemos mucho, pero a fin de mes no queda plata en la caja
                        </div>
                        <div
                            className="cure-pill"
                            onClick={() => window.dispatchEvent(new CustomEvent('open-fedi', { detail: { message: 'Tengo un producto increíble, pero nadie lo conoce' } }))}
                        >
                            Tengo un producto increíble, pero nadie lo conoce
                        </div>
                        <div
                            className="cure-pill"
                            onClick={() => window.dispatchEvent(new CustomEvent('open-fedi', { detail: { message: 'Estoy agotado: hago de gerente, vendedor y creativo al mismo tiempo' } }))}
                        >
