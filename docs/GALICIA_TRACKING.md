...
Ruta canónica de la campaña: `/bonificacion-galicia`.
...
- `source`: punto operativo exacto desde el que llegó el lead.
- `utm_source`: organización o sitio que originó el tráfico.
- `utm_medium`: canal.
